<header class="sticky top-0 z-20 bg-white border-b border-gray-200 h-16 flex items-center px-6 justify-between shadow-sm">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-bold text-gray-800">@yield('title', 'AtendeJá')</h1>
    </div>
    <div class="flex items-center gap-4">
        <form class="hidden md:block">
            <input type="text" placeholder="Pesquisar..." class="rounded-lg border border-gray-200 px-3 py-2 text-sm focus:ring-2 focus:ring-teal-200 focus:outline-none" aria-label="Pesquisar">
        </form>
        ...
        <div class="relative group">
            <button class="flex items-center gap-2 focus:outline-none">
                <span class="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold">U</span>
            ...
            <div class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-2 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity z-40">
